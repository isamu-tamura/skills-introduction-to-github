...
- 構築するもの：[プロフィールのREADME](https://docs.github.chttps://github.com/isamu-tamura/skills-introduction-to-github/account-and-profile/setting-up-and-managing-your-github-profile/customizing-your-profile/managing-your-profile-readme) として使用できる短い Markdown ファイルを作成します。
...
2. 新しいタブでは、ほとんどのプロンプトが自動的に入力されます。
   ...
   - プライベートリポジトリは [Actionsの分単位での課金が発生](https://docs.github.chttps://github.com/isamu-tamura/skills-introduction-to-github/billing/managing-billing-for-github-actions/about-billing-for-github-actions) するため、パブリックリポジトリを作成することをお勧めします。
...
<a id="start-exercise" href="https://github.com/isamu-tamura/skills-introduction-to-github/issues/1">
